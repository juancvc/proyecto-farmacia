		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<f:form id="frmListadoArticulo" role="form"
					action="${pageContext.request.contextPath}/ventaController/buscar">
					<!-- Begin Page Content -->
											...
											<table class="table table-bordered" id="dataTable"
												...
												<tbody class="tabla_td">
													<c:forEach var="venta" items="${lstVentas}"
														...
														<tr>
															<td>${loop.count}</td>
															<td>${venta.persona.nombreCompleto}</td>
															<td>${venta.persona.nroDocumento}</td>
															<td><fmt:formatDate pattern="dd/MM/yyyy" value="${venta.fechaEmision}"/></td>
															...
															<td><a title="Modificar" data-placement="top"
																...
																href="${pageContext.request.contextPath}/ventaController/rptTicketVenta?index=${loop.index}">
