			...
			<div id="content">
				...
				<f:form id="frmListadoArticulo" role="form"
					...
					<div class="container-fluid">
						...
						<!-- Page Heading -->
						<div class="tituloForm">LISTADO DE ALMACENES</div>
										...
										<div class="table-responsive">
											<table class="table table-bordered" id="dataTable"
												...
												<tbody class="tabla_td">
													<c:forEach var="almacen" items="${lstAlmacenes}"
														varStatus="loop">
														<tr>
															<td>${loop.count}</td>
															...
															<td><a title="Modificar" data-placement="top"
																...
																onclick="javascript:modificarElementoGenerico('/almacenController/modificar','${loop.index}')"
