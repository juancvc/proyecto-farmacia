		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<f:form id="frmListadoArticulo" role="form"
					action="${pageContext.request.contextPath}/laboratorioController/buscar">
					<!-- Begin Page Content -->
					<div class="container-fluid">

						<!-- Page Heading -->
						<div class="tituloForm">LISTADO DE LABORATORIOS</div>
										...
										<div class="table-responsive">
											<table class="table table-bordered" id="dataTable"
												...
												<tbody class="tabla_td">
													<c:forEach var="laboratorio" items="${lstLaboratorios}"
														varStatus="loop">
														<tr>
															<td>${loop.count}</td>
															...
															<td><a title="Modificar" data-placement="top"
																...
																onclick="javascript:modificarElementoGenerico('/laboratorioController/modificar','${loop.index}')"
					...
					<a style="display: none;" href="${pageContext.request.contextPath}/laboratorioController/listado"
