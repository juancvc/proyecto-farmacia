...
<title>Farmacia - Transferencia Institucional</title>
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<!-- End of Topbar -->
				<f:form id="frmListadoTransferencia" role="form"
					action="${pageContext.request.contextPath}/movimientoAlmacenController/buscar">
					<!-- Begin Page Content -->
					<div class="container-fluid">

						<!-- Page Heading -->
						<div class="tituloForm">LISTADO DE TRANSFERENCIAS</div>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-3 mb-1">
											<label for="lbltipoSeguroPaciente" class="label_control">TIPO MOVIMIENTO</label>
											<div class="controls"> 
												<f:select id="cboTipoMovimiento"
													path="tipo.idRegistro" class="form-control"> 
													<f:option value="" label="Seleccione" selected="true"
															disabled="disabled" />
													<f:options items="${lstTipo}"
														itemValue="codigo" itemLabel="descripcionCorta" />
												</f:select>
											</div>
										</div> 
									<div class="col-md-3 mb-2">
											...
											<f:input class="form-control" id="dateHasta" name="dateHasta"
												...
												type="text" path="sFechaTransferenciaDesde"
										...
										<div class="col-md-3 mb-2">
											...
											<f:input class="form-control" id="dateHasta" name="dateHasta"
												maxlength="10" placeholder="DD/MM/YYYY"
												type="text" path="sFechaTransferenciaHasta"
												onkeyup="this.value=formateafechaNacimiento(this.value);" />
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-12 text-right"
											...
											<a
											href="${pageContext.request.contextPath}/movimientoAlmacenController/nuevaTransferencia"
										...
										<div class="table-responsive">
											<table class="table table-bordered" id="dataTable"
												...
												<tr>
															<td>1</td>
															<td>30/05/2021</td>
															<td>INGRESO X TRANSFERENCIA INSTITUCIONAL</td>
															<td>ORDEN</td>
															<td>0054-2021</td>
															...
															<td><a title="Modificar" data-placement="top"
																...
																<button type='button'
																	...
																	title='Eliminar'
																	onclick="confirmar_eliminar(1,3);"
														...
														<tr>
															...
															<td>ORDEN</td>
															<td>0087-2021</td>
															<td>INSTITUTO NACIONAL DEL NIÑO</td>
															<td>S/. 1290.00</td>
															<td>AVILLONC</td>
															<td><a title="Modificar" data-placement="top"
																	data-toggle="tooltip"
													...
													<c:forEach var="compra" items="${lstTransferencias}"
														varStatus="loop">
														<tr>
															<td>${loop.count}</td>
	...
	document.getElementById('enlaceTransferenciaInsti').className = "collapse-item active";
