...
<body id="page-top">
			...
			<div id="content">
				...
				<f:form id="frmRegistrarCompra" role="form" action=""
					...
					<div class="container-fluid">
						...
						<!-- Page Heading -->
						<div class="tituloForm">GENERAR TRANSFERNCIA INSTITUCIONAL</div>
											...
											<div class="col-md-3 mb-2">
												...
												<div class="controls">
													<f:input type="text" class="form-control" required="required"
														id="txtAlias" path="nroDocumento" autocomplete="off" maxlength="15" />
												</div>
											</div>
											<div class="col-md-3 mb-1">
												<label for="nombreCompleto" class="label_control">FECHA TRANSFERENCIA 
												...
												<div class="controls">
													<f:input class="form-control" id="date" name="date" maxlength="10" 
														...
														path="sFechaMovimiento" onkeyup="this.value=formateafechaNacimiento(this.value);"/> 

												</div>
											</div>
											<div class="col-md-3 mb-1">
											<label for="lbltipoSeguroPaciente" class="label_control">INSTITUCION EXTERNA
											<span class="required">*</span></label>
											<div class="controls"> 
												<f:select id="cboTipoArticulo"
													path="institucionBean.codigo" class="form-control"> 
													<f:option value="" label="Seleccione" selected="true"
															disabled="disabled" />
													<f:options items="${lstInstitucion}"
																...
																<c:forEach var="objCompraItem" items="${lstComprasItems}"
																	...
																	<tr>
																		...
																		<td><input type='text' class='form-control'  id="${objCompraItem.stock.articulo.codigo}"
										 									...
										 									onchange = 'calculaSubTotal(); 'maxlength='15'/></td>
																		<td><input type='text' class='form-control' id="${objCompraItem.stock.articulo.codigo}" 
	...
	<!-- scripts  -->
	<script
			src="${pageContext.request.contextPath}/assets/js/page/movimiento/transferenciaInstitucional.js"
