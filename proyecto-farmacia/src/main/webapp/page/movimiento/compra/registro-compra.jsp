									...
									<div class="form-group">
										<div class="row">
											<div class="form-group col-md-3 mb-1">
												<label for="exampleInputName" class="label_control">TIPO DOCUMENTO
													<span class="required">*</span>
												</label>
												<div class="controls">
													<f:select id="tipoDocumentoPaciente" path="tipoDocumento.idRegistro"
											...
											<div class="col-md-3 mb-2">
												...
												<div class="controls">
													<f:input type="text" class="form-control" required="required"
														id="txtAlias" path="numeroDocumento" autocomplete="off" maxlength="15" />
												</div>
											</div>
											<div class="col-md-3 mb-1">
												<label for="nombreCompleto" class="label_control">FECHA EMISION 
											...
											<div class="col-md-3 mb-1">
											<label for="lbltipoSeguroPaciente" class="label_control">ALMACEN
											<span class="required">*</span></label>
											<div class="controls"> 
										...
										<div class="row">
											<div class="form-group col-md-6 mb-2">
												<label for="exampleInputName" class="label_control">PROVEEDOR
													<span class="required">*</span>
												</label>
												<f:select id="tipoDocumentoPaciente"
													path="proveedor.codigo" required="required"
													class="form-control">
													<f:option value="" label="Seleccione" selected="true"
														disabled="disabled" />
													<f:options items="${lstProveedor}" itemValue="codigo"
														itemLabel="nombreProveedor" />
												</f:select>
											</div>
											<div class="form-group col-md-3 mb-1">
												<label for="exampleInputName" class="label_control">PROCESO SELECCION 
													<span class="required">*</span>
												</label>
												<f:select id="tipoDocumentoPaciente"
													path="tipoProcesoSeleccion.idRegistro" required="required"
													class="form-control">
													<f:option value="" label="Seleccione" selected="true"
														disabled="disabled" />
													<f:options items="${lstProcesoSeleccion}" itemValue="idRegistro"
														itemLabel="descripcionCorta" />
												</f:select>
											</div>
											<div class="form-group col-md-3 mb-1">
												<label for="exampleInputName" class="label_control">TIPO FINANCIAMIENTO
													<span class="required">*</span>
												</label>
												<f:select id="tipoDocumentoPaciente"
													path="tipoFinanciamiento.idRegistro" required="required"
													class="form-control">
													<f:option value="" label="Seleccione" selected="true"
														disabled="disabled" />
													<f:options items="${lstTipoFinanciamiento}" itemValue="idRegistro"
														itemLabel="descripcionCorta" />
												</f:select>
											</div>
										</div> 
