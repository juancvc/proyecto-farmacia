            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">VENTAS ANULADAS</div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">COMPRAS</div>
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Por tipo paciente</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
					...
					varStatus="loop"><c:choose>
						<c:when test="${loop.index==0}">
							<span class="mr-2">
		                      <i class="fas fa-circle text-primary"></i>${venta.tipoFinanciador.descripcionCorta}
		                    </span>
						</c:when>
						<c:when test="${loop.index==1}">
							<span class="mr-2">
		                      <i class="fas fa-circle text-success"></i>${venta.tipoFinanciador.descripcionCorta}
		                    </span>
						</c:when>
						<c:when test="${loop.index==2}">
							<span class="mr-2">
		                      <i class="fas fa-circle text-info"></i>${venta.tipoFinanciador.descripcionCorta}
		                    </span>
						</c:when>
						<c:when test="${loop.index==3}">
							<span class="mr-2">
		                      <i class="fas fa-circle tipo4"></i>${venta.tipoFinanciador.descripcionCorta}
		                    </span>
						</c:when>
						<c:when test="${loop.index==4}">
							<span class="mr-2">
		                      <i class="fas fa-circle tipo5"></i>${venta.tipoFinanciador.descripcionCorta}
		                    </span>
						</c:when>
					</c:choose>
					</c:forEach>
...
-->
  ...
  <!-- Page level plugins -->
  <script src="${pageContext.request.contextPath}/app-assets/vendor/chart.js/Chart.min.js"></script>
