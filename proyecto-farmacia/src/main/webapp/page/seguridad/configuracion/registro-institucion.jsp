...
<title>Farmacia - Institución</title>
...
<body id="page-top">
			...
			<div id="content">
				...
				<f:form id="frmRegistroAlmacen" role="form" action=""
					...
					<div class="container-fluid">
						...
						<!-- Page Heading -->
						<div class="tituloForm">CONFIGURAR INSTITUCION</div>
								...
								<div class="card-body">
									<div class="form-group">
										...
										<div class="row">
											...
											<div class="form-group col-md-4 mb-2">
												<label for="nombreCompleto" class="label_control">LOGO
													<span class="required">*</span>
												</label>
												<div class="controls">
													<div class="input-group">
														...
														</label> <input type="text" id="nombreArchivo" class="form-control" readonly>
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="form-group col-md-8 mb-2">
												<label for="nombreCompleto" class="label_control">DOMICILIO FISCAL
												</label>
												<div class="controls">
													<f:input type="text" class="form-control"
	...
	$(document).ready( function() {
		...
		document.getElementById('enlaceInstitucion').className = "collapse-item active";
