			...
			<div id="content">
				...
				<f:form id="frmListadoArticulo" role="form"
					...
					<div class="container-fluid">
						...
						<!-- Page Heading -->
						<div class="tituloForm">LISTADO DE TIPO DE PRECIOS</div>
										...
										<div class="col-md-6 mb-2">
											...
											<div class="controls">
												<f:input type="text" class="form-control"
													required="required" id="txtnombre" path="descripcionCorta" />
										...
										<div class="table-responsive">
											<table class="table table-bordered" id="dataTable"
												...
												<thead>
													<tr class="tabla_th">
														<th width="20%">ITEM</th>
														<th width="80%">NOMBRE PRECIO</th> 
														<th width="20%">ACCIONES</th>
													</tr>
												</thead>
												<tfoot>
												<tbody class="tabla_td">
													<c:forEach var="precio" items="${lstTipoPrecios}"
														varStatus="loop">
														<tr>
															<td>${loop.count}</td>
															<td>${precio.descripcionCorta}</td>
															<td><a title="Modificar" data-placement="top"
																data-toggle="tooltip"
																class="btn btn-outline-success btn-sm"
																onclick="javascript:modificarElementoGenerico('/precioController/modificar','${loop.index}')"
