			...
			<div id="content">
				...
				<f:form id="frmRegistroAlmacen" role="form" action=""
					...
					<div class="container-fluid">
						...
						<!-- Page Heading -->
						<div class="tituloForm">REGISTRO PRECIOS</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="form-group col-md-8 mb-2">
												<label for="nombreCompleto" class="label_control">NOMBRE <span class="required">*</span>
												</label>
												<div class="controls">
													<f:input type="text" class="form-control"
														required="required"
														onkeyup="javascript:this.value=this.value.toUpperCase();"
														id="txtNombreAlmacen" path="descripcionCorta" maxlength="120"/>
									...
									<div class="row">
											<div class="form-group col-md-8 mb-2">
												...
												<div class="controls">
												 ...
												 id="descripcion" path="descripcionLarga" rows="3" maxlength="350"/>  
												</div>
											</div>
