 ...
 */
@Embeddable
public class PreparadoPK implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;

	@Column(name="ID_ORGANIZACION_PREPARADO")
	private int idOrganizacionPreparado;

	@Column(name="ID_INSTITUCION_PREPARADO")
	private int idInstitucionPreparado;

	@Column(name="ID_SEDE_PREPARADO")
	private int idSedePreparado;

	@Column(name="NRO_VERSION_PREPARADO")
	private int nroVersionPreparado;

	@Column(name="NRO_PERIODO_PREPARADO")
	private int nroPeriodoPreparado;

	@Column(name="ID_PREPARADO")
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PreparadoPK)) {
			return false;
		}
		PreparadoPK castOther = (PreparadoPK)other;
		return 
