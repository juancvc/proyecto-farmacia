...
import sigelab.core.repository.interfaces.general.Maestra2DAO;
import sigelab.core.repository.interfaces.general.Maestra6DAO;
...
@Transactional
@Repository("maestra6DAO")
public class Maestra6DAOImp implements Maestra6DAO {
