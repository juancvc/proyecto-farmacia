...
@Controller
@RequestMapping(value = "MovimientoController")
public class MovimientoController extends BaseController{
	...
	public ModelAndView doListado(@ModelAttribute("MovimientoBean") MovimientoAlmacenBean MovimientoBean, HttpServletRequest request) {
		ModelAndView mav = new ModelAndView("mantenimiento/articulo/listado-articulo", "command", MovimientoBean); 
	...
	@ResponseBody
	public ModelAndView listado(@ModelAttribute("MovimientoBean") MovimientoAlmacenBean MovimientoBean, HttpServletRequest request){
