...
@Controller
@RequestMapping(value = "precioController")
public class PreciosController extends BaseController{
	...
	public ModelAndView doNuevo(HttpServletRequest request) {
		...
		ModelAndView mav = new ModelAndView("inventario/precio/registro-precio", "command", catalogoBean); 
	//	this.cargarCombos(mav);
		return mav;
	}
