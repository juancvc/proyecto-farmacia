...
public class AlmacenDAOImpl implements AlmacenDAO {
	...
	public boolean insertar(AlmacenBean almacen) throws DAOException {
		...
		try {
			...
			spq.setParameter("idTipoCat02", almacen.getTipo().getIdRegistro());
	...
	@Override
	public List<AlmacenBean> getBuscarPorFiltros(AlmacenBean almacen) throws DAOException {
		...
		spq.setParameter("nombreAlmacen", almacen.getNombreAlmacen());
		spq.setParameter("idTipoCat02", almacen.getTipo().getIdRegistro());
		spq.setParameter("swPrincipal", almacen.getSwPrincipal());
	...
	private AlmacenBean deObjetoAObjetoBean(Almacen entity) {
		...
		if (entity != null) {
			...
			bean.getTipo().setIdRegistro(entity.getIdTipoCat02());
			bean.setSwPrincipal(entity.getSwPrincipal());
		}
