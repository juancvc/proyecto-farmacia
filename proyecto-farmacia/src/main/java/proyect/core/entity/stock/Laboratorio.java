...
@NamedStoredProcedureQueries({
		...
		@NamedStoredProcedureQuery(name = "laboratorio.findByObject", procedureName = "[dbo].[usp_Laboratorio_buscarxID]", resultClasses = Laboratorio.class, parameters = {

				@StoredProcedureParameter(mode = ParameterMode.IN, name = "idLaboratorio", type = String.class) }),
		@NamedStoredProcedureQuery(name = "laboratorio.buscarPorFiltros", procedureName = "[dbo].[usp_Laboratorio_buscarxCriterios]", resultClasses = Laboratorio.class, parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "nombreLaboratorio", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "descripcion", type = String.class) }),

		@NamedStoredProcedureQuery(name = "laboratorio.buscarTodos", procedureName = "[dbo].[usp_Laboratorio_buscarTodos]", resultClasses = Laboratorio.class
		/*
		 * parameters={
		 * 
		...
		@NamedStoredProcedureQuery(name = "laboratorio.insert", procedureName = "[dbo].[usp_Laboratorio_insertar]", parameters = {
		...
		@NamedStoredProcedureQuery(name = "laboratorio.update", procedureName = "[dbo].[usp_Laboratorio_actualizar]", parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "idLaboratorio", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "nombreLaboratorio", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "descripcion", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "ruc", type = String.class),
		...
		@NamedStoredProcedureQuery(name = "laboratorio.delete", procedureName = "[dbo].[usp_Laboratorio_eliminar]", parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "idLaboratorio", type = String.class) }),
		@NamedStoredProcedureQuery(name = "laboratorio.validar", procedureName = "dbo.SP_PRESENTACION_VALIDAR", resultClasses = Laboratorio.class, parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "idLaboratorio", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "nombreLaboratorio", type = String.class) })
