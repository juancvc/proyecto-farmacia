package proyect.core.entity.asistencial.maestras;
...
@NamedStoredProcedureQueries({
		@NamedStoredProcedureQuery(name = "tgemae14.buscarPorFiltros", procedureName = "[GENE].[USP_TMAGE14_FINDBYLIKEOBJECT]", resultClasses = TgemaeAsis14.class, parameters = {

				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODTABLA", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODREGIS", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "NOMCORTO", type = String.class)

		}), @NamedStoredProcedureQuery(name = "tgemae14.listarPorCodigoTabla", procedureName = "[GENE].[USP_TMAGE14_LISTAR_X_CODTABLA]", resultClasses = TgemaeAsis14.class, parameters = {

				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODTABLA", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "TIPO", type = int.class)

		}), @NamedStoredProcedureQuery(name = "Tgemae14.listar", procedureName = "gene.fun_leotbcmaestra_buscar_x_filtros", resultClasses = TgemaeAsis14.class, parameters = { @StoredProcedureParameter(mode = ParameterMode.IN, name = "p_codtabla", type = String.class), @StoredProcedureParameter(mode = ParameterMode.IN, name = "p_nomcorto", type = String.class) }),

		@NamedStoredProcedureQuery(name = "Tgemae14.listarTodasTablas", procedureName = "[RECO].[USP_LISTAR_TABLAS_MAESTRAS]", resultClasses = TgemaeAsis14.class, parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "TABLA", type = String.class) }),

		@NamedStoredProcedureQuery(name = "Tgemae14.actualizar", procedureName = "[GENE].[USP_TMAGE14_UPDATE]", resultClasses = TgemaeAsis14.class, parameters = {

				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODTABLA", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODREGIS", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "NOMCORTO", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "NOMLARGO", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "VALGEN01", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "VALGEN02", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "VALGEN03", type = String.class) }),

		@NamedStoredProcedureQuery(name = "Tgemae14.insertar", procedureName = "[GENE].[USP_TMAGE14_INSERT]", resultClasses = TgemaeAsis14.class, parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODTABLA", type = String.class),
		...
		@NamedStoredProcedureQuery(name = "Tgemae14.eliminar", procedureName = "[GENE].[USP_TMAGE14_DELETE]", resultClasses = TgemaeAsis14.class, parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODTABLA", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODREGIS", type = String.class) }),

		@NamedStoredProcedureQuery(name = "Tgemae14.buscarXcod_Tabla_Registro", procedureName = "[GENE].[USP_TMAGE14_FINDBYOBJECT]", resultClasses = TgemaeAsis14.class, parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODTABLA", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODREGIS", type = String.class) }),
...
@Entity
@Table(name = "[GENE].Tgemae14")
public class TgemaeAsis14 implements Serializable {
