package proyect.core.entity.asistencial.banco;
 ...
 */
@Embeddable
public class PreDonanteEntrevistaPK implements Serializable {
	...
	@Column(name="CODRESPU")
	private String codRespu;
	...
	public String getCodRespu() {
		return codRespu;
	}
	public void setCodRespu(String codRespu) {
		this.codRespu = codRespu;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PreDonanteEntrevistaPK)) {
			return false;
		}
		PreDonanteEntrevistaPK castOther = (PreDonanteEntrevistaPK)other;
		return 
			this.codorgan.equals(castOther.codorgan)
			&& this.codinsti.equals(castOther.codinsti)
			&& this.codsedei.equals(castOther.codsedei)
			&& this.codRespu.equals(castOther.codRespu)
	...
	public int hashCode() {
		...
		hash = hash * prime + this.codRespu.hashCode();
