 ...
 */
@Embeddable
public class DonantePK implements Serializable {
	...
	@Column(name="CODFLETO")
	private String codFleto;
	...
	public String getCodFleto() {
		return codFleto;
	}
	public void setCodFleto(String codFleto) {
		this.codFleto = codFleto;
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.codFleto.hashCode();
