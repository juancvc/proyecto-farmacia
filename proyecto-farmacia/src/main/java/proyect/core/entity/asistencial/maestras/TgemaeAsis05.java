...
@NamedStoredProcedureQueries({
		@NamedStoredProcedureQuery(name = "tgemaeAsis05.buscarPorFiltros", procedureName = "[GENE].[USP_TMAGE05_FINDBYLYKEOBJECT]", 
				resultClasses = TgemaeAsis05.class, parameters = {
						
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "CODTABLA", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "VALGEN10", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "TIPO", type = int.class)
				
		}),
				@NamedStoredProcedureQuery(name = "tgemaeAsis05.listarPorCodigoTabla", procedureName = "[GENE].[USP_TMAGE05_LISTAR_X_CODTABLA]", 
				resultClasses = TgemaeAsis05.class, parameters = {
...
@Entity
@Table(name="TGEMAE05ASIS")
@NamedQuery(name="Tgemae01.findAll", query="SELECT t FROM Tgemae01 t")
public class TgemaeAsis05 implements Serializable {
	...
	public void setValgen06(String valgen05) {
		this.valgen05 = valgen05;
	}
