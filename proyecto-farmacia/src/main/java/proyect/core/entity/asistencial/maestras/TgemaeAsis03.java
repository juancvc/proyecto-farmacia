...
@NamedStoredProcedureQueries({
		@NamedStoredProcedureQuery(name = "tgemaeAsis03.buscarPorFiltros", procedureName = "[GENE].[USP_TMAGE03_FINDBYOBJECT]", 
				resultClasses = TgemaeAsis03.class, parameters = {
				...
				@NamedStoredProcedureQuery(name = "tgemaeAsis03.listarPorCodigoTabla", procedureName = "[GENE].[USP_TMAGE03_LISTAR_X_CODTABLA]", 
				resultClasses = TgemaeAsis03.class, parameters = {
		...
		@NamedStoredProcedureQuery(name = "tgemaeAsis03.listar",
		...
		@NamedStoredProcedureQuery(name = "tgemaeAsis03.listarComboGeneral",
		...
		@NamedStoredProcedureQuery(name = "tgemaeAsis03.actualizar", procedureName = "gene.fun_leotbcmaestras_actualizar", 
		 		resultClasses = TgemaeAsis03.class, parameters = { 
		 ...
		 @NamedStoredProcedureQuery(name = "tgemaeAsis03.insertar", procedureName = "gene.fun_leotbcmaestras2_insertar", 
				resultClasses = TgemaeAsis03.class, parameters = {
...
//				 
		 @NamedStoredProcedureQuery(name = "tgemaeAsis03.buscarXcod_Tabla_Registro", procedureName = "gene.fun_leotbcmaestra_buscar_x_codRegistro_codTabla", 
		 		resultClasses = TgemaeAsis03.class, parameters = { 
		 		@StoredProcedureParameter(mode = ParameterMode.IN, name = "p_codtabla", type = String.class),
		 		@StoredProcedureParameter(mode = ParameterMode.IN, name = "p_codregis", type = Integer.class) }),  
...
@Entity
@Table(name="TGEMAE03ASIS")
public class TgemaeAsis03 implements Serializable {
