...
@NamedStoredProcedureQueries({
		@NamedStoredProcedureQuery(name = "tgemaeAsis01.listarPorCodigoTabla", procedureName = "[GENE].[USP_TMAGE01_LISTAR_X_CODTABLA]", 
			resultClasses = TgemaeAsis01.class, parameters = {					
...
@Entity
@Table(name="TGEMAE01ASIS")
@NamedQuery(name="Tgemae01.findAll", query="SELECT t FROM Tgemae01 t")
public class TgemaeAsis01 implements Serializable {
