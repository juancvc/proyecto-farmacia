...
@NamedStoredProcedureQueries({
		@NamedStoredProcedureQuery(name = "tgemaeBanc01.listarPorCodigoTabla", procedureName = "[SIGEHOV2BANC].[GENE].[USP_TMAGE01_LISTAR_X_CODTABLA]", 
			resultClasses = TgemaeBanc01.class, parameters = {					
...
@Entity  
public class TgemaeBanc01 implements Serializable {
