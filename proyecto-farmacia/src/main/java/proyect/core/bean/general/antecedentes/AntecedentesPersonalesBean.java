...
public class AntecedentesPersonalesBean extends BaseBean{
	/****************************************************/	
	 public static int VALOR_NULL = 0;
	 public static int VALOR_SI = 1;
	 public static int VALOR_NO = 2;
	 public static int VALOR_NS = 3;
	 /******************************************************/
	
	private AntecedentesPacienteBean antecedentesPaciente;
	private TablaBean antPersonal;
	private int valor=0;
	

	public TablaBean getAntPersonal() {
		return antPersonal;
	}
	public void setAntPersonal(TablaBean antPersonal) {
